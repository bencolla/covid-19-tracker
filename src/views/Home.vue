<template>
  <div class="home">
    <img style="width: 100%; max-width: 30rem" alt="Vue logo" src="../assets/source.gif">
    <h1>Select your country</h1>
    <multiselect place-holder="Select country" @input="save" class="select" track-by="code" label="name" v-model="value" :options="options"></multiselect>
...
export default {
  ...
  methods : {
    save(){
      localStorage.setItem('code', this.value.code)
